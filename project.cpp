		...
		if (strcmp(UserId, "SANDHYA") == 0)
		{
			...
			if (strcmp(Pass, "SANDHYA") == 0)
			{
				...
				do
				{
					...
					cout << "HOW CAN I HELP YOU .PLEASE TELL ME.PLEASE ENTER YOUR QUERY IN SMALL LETTERS. " << endl
						 << endl
						 << endl;
					...
					{
						cout << "YOU CAN TYPE ANY NUMBER FROM 1 TO 10 FOR FOLLOWING OPERATION \n";
						string s = "YOU CAN TYPE ANY NUMBER  FROM  1 TO 10 FOR FOLLOWING OPERATION ";
						assist(s);

						cout << "THE COMMAND LIST IS :" << endl
							 << " 1) hi or hey or hello" << endl
							 << " 2) bye or stop or exit\n 3) date \n 4) open notepad\n 5) calculation\n 6) open google\n 7) open YouTube\n 8) open scaler\n 9) open gaana\n 10) open github\n ";
					}
					else if (strcmp(query, "hi") == 0 || strcmp(query, "hey") == 0 || strcmp(query, "hello") == 0 || strcmp(query, "1") == 0)
					{
						cout << "HELLO Sandhya..." << endl;
					...
					else if (strcmp(query, "bye") == 0 || strcmp(query, "stop") == 0 || strcmp(query, "exit") == 0 || strcmp(query, "2") == 0)
					{
						...
						string s = "ok Sandhya! have a nice day ";
						assist(s);
